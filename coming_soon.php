                        ...
                        <div class="col">
                            <div class="voting-contents mt-5">
                                <center>
                                    ...
                                    ?>
                                    <img src="img/photos/notyetstarted.png" alt="Not yet started" style="height: 200px;">
                                    <h2>The election is not yet started!</h2>
                                    <h3 class="fs-5">We will be starting soon.</h3>
                                </center>
                            </div>
                        </div>
                    </div>

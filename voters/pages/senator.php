                    ...
                    <div class="row d-flex justify-content-center">
                        <div class="col">
                            ...
                            <div class="running-candidates">
                                    <div class="row">
                                        <h5 class="text-center mt-3">for Senator</h5>
                                        <div class="col p-2">
                                            <center>
                                            <?php 
                                            $myrow = $oop->displaySenCan($date);
                                            foreach ($myrow as $row) {
                                            ?>
                                            <a href="?process=sen&voted=<?=$row['id']?>" class="btn btn-link">
                                                <div class="card">
                                                    <div class="card-body">
                                                        <?php 
                                                        if (isset($_SESSION['sen'])) {
                                                            if ($_SESSION['sen'] == $row['id']) {
                                                                echo "<p>Voted!</p>";
                                                            }
                                                        }
                                                        ?>
                                        ...
                                        <div class="buttons text-center">
                                            <a href='?process=swo' class='btn btn-secondary btn-lg me-2'><i class='fa-solid fa-backward'></i> Back</a>
                                            <a href='?process=review' class='btn btn-primary btn-lg me-2'>Proceed <i class='fa-solid fa-caret-right'></i></a>
                                        </div>
                                    </div>
                            </div>
                        </div>

									...
									<div class="col-sm-4">
										...
										<div class="card box-info">
											<div class="card-body">
												<div class="row">
													<div class="col mt-0">
														<h5 class="card-title">Comelec</h5>
													</div>
													<div class="col-auto">
														<div class="stat text-primary">
															<img src="../img/logo/comelec-logo.png" alt="Comelec Logo" height="33px">
														</div>
													</div>
												</div>
												<h1 class="mt-1 mb-3">
													<?php 
														$myrow = $oop->displayComCnt($date);
														foreach ($myrow as $cnt){
															echo $cnt['total_comelec'];
														} ?>
												</h1>
											</div>
										</div>
										...
										<tbody>
											...
											<tr>
												...
												<td>
													...
													<a href="?page=candidates" class="badge bg-danger"><i class="align-middle" data-feather="trash-2"></i></a>
												</td>
											</tr>
											<?php } ?>
										</tbody>

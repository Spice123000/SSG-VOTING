				<?php 
					...
					require_once('process/addAccessCode.php');
				?>
                        ...
                        <div class="col-md-4">
                            <form method="POST" id="generateCode">
                                <div class="card shadow p-3">
                                        <button class="btn btn-success mb-2" name="addAC" type="submit"><i class="align-middle" data-feather="plus"></i> Generate Access Code</button>   
                                        <span class="text-center" style="font-size: 12px;">* this will generate 50 access code</span>
                                </div>
                            </form>
                        </div>
                        <div class="col">
